...
namespace EasyVulkan {
    ...
    class Device{
        ...
        void create_logical_device(VkPhysicalDeviceFeatures enabled_features, vector<const char *> enabled_extensions, VkQueueFlags queue_types = VK_QUEUE_GRAPHICS_BIT, void *next = nullptr, bool use_swapchain = false);
